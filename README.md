...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-g8swu8i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-g8swu8i.containers.anotherwebservice.com/
...
```
git clone git@github.com:Tredecillion-Team/container-g8swu8i.git
cd container-g8swu8i
```
...
```
docker attach container-g8swu8i
```
